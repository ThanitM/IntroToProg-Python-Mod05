...
#   Thanit Mitparien,07/28/2026, Update the script to use dictionaries, files and exception
#                                   handling.
# ------------------------------------------------------------------------------------------ #
...
while (True):
    ...
    if menu_choice == "1":  # This will not work if it is an integer!
        try:
            ...
            print(f"Student's First name and Last name must only be alphanumeric")
            print("-- Technical Error Message -- ")
            print(e, e.__doc__, type(e), sep='\n')
        except Exception as e:
            print("There was a non-specific error!\n")
    ...
    # Save the data to a file
        ...
        try:
            ...
            print("please check that the data is a valid json file!\n")
            print("-- Technical Error Message -- ")
            print(e, e.__doc__, type(e), sep="\n")
        except Exception as e:
            print("-- Technical Error Message -- ")
